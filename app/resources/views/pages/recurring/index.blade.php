    ...
    <div class="space-y-3 mb-6">
        ...
        <x-card class="p-4">
            <div class="flex items-start gap-3">
                ...
                {{-- Acciones --}}
                <div class="flex flex-col gap-1 flex-shrink-0" x-data>
                    ...
                    <form method="POST" action="{{ route('recurring.apply-now', $charge) }}"
                          onsubmit="return confirm('¿Aplicar «{{ addslashes($charge->name) }}» ahora?')">
                        @csrf
                        <button type="submit" title="Aplicar ahora"
