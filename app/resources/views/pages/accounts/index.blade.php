...
$instLabels = [
    'banamex' => 'Banamex', 'mercadopago' => 'MercadoPago', 'nu' => 'Nu',
    ...
    <div class="bg-white dark:bg-[#2a2a2a] divide-y divide-[#ababab]/10">
        ...
        <div class="flex items-center gap-3 px-4 py-3.5 cursor-pointer hover:bg-[#f9f9f9] dark:hover:bg-white/5 transition-colors group"
            ...
            <a href="{{ route('accounts.edit', $account) }}"
               ...
               class="w-8 h-8 flex items-center justify-center text-[#ababab] hover:text-[#76a72b] hover:bg-[#76a72b]/10 rounded-lg transition-colors opacity-0 group-hover:opacity-100 flex-shrink-0">
